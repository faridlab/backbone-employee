...
--
-- This file contains initial seed data for the employee.examples table.
-- Customize this file to add your initial data.

-- INSERT INTO employee.examples (
--     id,
--     name,
--     description,
--     status,
...
-- INSERT INTO employee.examples (id, code, name, is_active, created_at, updated_at) VALUES
