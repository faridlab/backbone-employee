...
--
-- This file contains initial seed data for the employee.banks table.
-- Customize this file to add your initial data.

-- INSERT INTO employee.banks (
--     id,
--     name,
--     code,
--     metadata
...
-- INSERT INTO employee.banks (id, code, name, is_active, created_at, updated_at) VALUES
