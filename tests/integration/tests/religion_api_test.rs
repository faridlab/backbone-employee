//! Religion API Integration Tests
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Tests the Religion CRUD API endpoints.
...
// ============================================================================
// RELIGION TEST DATA GENERATOR
// ============================================================================

/// Test data generator for Religion
pub struct ReligionTestData;

impl TestDataGenerator for ReligionTestData {
...
/// Religion API test suite
pub struct ReligionApiTest {
    inner: GenericCrudTest<ReligionTestData>,
}

impl ReligionApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/religions", "Religion");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, ReligionTestData),
        }
    }
...
impl Default for ReligionApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
// <<< CUSTOM TESTS START >>>
// Add Religion specific tests here
// <<< CUSTOM TESTS END >>>
