//! EmployeeContact DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new EmployeeContact
///
...
/// Request DTO for full update of a EmployeeContact
///
...
/// Request DTO for partial update of a EmployeeContact
///
...
/// Response DTO for EmployeeContact entity
///
...
/// Paginated list response for EmployeeContact entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct EmployeeContactListResponseDto {
    /// List of items
    pub items: Vec<EmployeeContactResponseDto>,
...
impl EmployeeContactListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<EmployeeContactResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<EmployeeContact> for EmployeeContactResponseDto {
...
impl From<EmployeeContact> for EmployeeContactSummaryDto {
    fn from(entity: EmployeeContact) -> Self {
...
impl From<CreateEmployeeContactDto> for EmployeeContact {
...
impl backbone_core::FromCreateDto<CreateEmployeeContactDto> for EmployeeContact {
    fn from_create_dto(dto: CreateEmployeeContactDto) -> backbone_core::ServiceResult<Self> {
        Ok(EmployeeContact::from(dto))
    }
}
