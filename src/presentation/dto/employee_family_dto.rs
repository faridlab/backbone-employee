//! EmployeeFamily DTOs (Data Transfer Objects)
//!
...
use crate::domain::entity::FamilyRelationship;

// =============================================================================
// Create DTO
// =============================================================================

/// Request DTO for creating a new EmployeeFamily
///
...
/// Request DTO for full update of a EmployeeFamily
///
...
/// Request DTO for partial update of a EmployeeFamily
///
...
/// Response DTO for EmployeeFamily entity
///
...
/// Paginated list response for EmployeeFamily entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct EmployeeFamilyListResponseDto {
    /// List of items
    pub items: Vec<EmployeeFamilyResponseDto>,
...
impl EmployeeFamilyListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<EmployeeFamilyResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<EmployeeFamily> for EmployeeFamilyResponseDto {
...
impl From<EmployeeFamily> for EmployeeFamilySummaryDto {
    fn from(entity: EmployeeFamily) -> Self {
...
impl From<CreateEmployeeFamilyDto> for EmployeeFamily {
...
impl backbone_core::FromCreateDto<CreateEmployeeFamilyDto> for EmployeeFamily {
    fn from_create_dto(dto: CreateEmployeeFamilyDto) -> backbone_core::ServiceResult<Self> {
        Ok(EmployeeFamily::from(dto))
    }
}
