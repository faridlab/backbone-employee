//! Specifications for DataConsent aggregate
//!
...
// Each predicate implements `Specification<DataConsent>` and can be combined
...
//
// pub struct ActiveDataConsentSpec;
// impl Specification<DataConsent> for ActiveDataConsentSpec {
//     fn is_satisfied_by(&self, e: &DataConsent) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
