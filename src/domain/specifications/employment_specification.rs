//! Specifications for Employment aggregate
//!
...
// Each predicate implements `Specification<Employment>` and can be combined
...
//
// pub struct ActiveEmploymentSpec;
// impl Specification<Employment> for ActiveEmploymentSpec {
//     fn is_satisfied_by(&self, e: &Employment) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
