//! Specifications for EmployeeBpjs aggregate
//!
...
// Each predicate implements `Specification<EmployeeBpjs>` and can be combined
...
//
// pub struct ActiveEmployeeBpjsSpec;
// impl Specification<EmployeeBpjs> for ActiveEmployeeBpjsSpec {
//     fn is_satisfied_by(&self, e: &EmployeeBpjs) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
