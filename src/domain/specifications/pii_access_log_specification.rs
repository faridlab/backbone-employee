//! Specifications for PiiAccessLog aggregate
//!
...
// Each predicate implements `Specification<PiiAccessLog>` and can be combined
...
//
// pub struct ActivePiiAccessLogSpec;
// impl Specification<PiiAccessLog> for ActivePiiAccessLogSpec {
//     fn is_satisfied_by(&self, e: &PiiAccessLog) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
