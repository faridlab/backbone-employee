//! Specifications for EmployeeTax aggregate
//!
...
// Each predicate implements `Specification<EmployeeTax>` and can be combined
...
//
// pub struct ActiveEmployeeTaxSpec;
// impl Specification<EmployeeTax> for ActiveEmployeeTaxSpec {
//     fn is_satisfied_by(&self, e: &EmployeeTax) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
