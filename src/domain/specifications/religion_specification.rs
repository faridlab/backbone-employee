//! Specifications for Religion aggregate
//!
...
// Each predicate implements `Specification<Religion>` and can be combined
...
//
// pub struct ActiveReligionSpec;
// impl Specification<Religion> for ActiveReligionSpec {
//     fn is_satisfied_by(&self, e: &Religion) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
