//! Domain policy for EmployeeWorkExperience aggregate
//!
...
/// Domain policy for EmployeeWorkExperience — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EmployeeWorkExperience>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EmployeeWorkExperienceDomainPolicy = PermitAllPolicy<EmployeeWorkExperience>;
