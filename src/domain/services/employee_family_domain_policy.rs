//! Domain policy for EmployeeFamily aggregate
//!
...
/// Domain policy for EmployeeFamily — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EmployeeFamily>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EmployeeFamilyDomainPolicy = PermitAllPolicy<EmployeeFamily>;
