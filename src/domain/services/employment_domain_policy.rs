//! Domain policy for Employment aggregate
//!
...
/// Domain policy for Employment — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Employment>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EmploymentDomainPolicy = PermitAllPolicy<Employment>;
