//! Domain policy for Religion aggregate
//!
...
/// Domain policy for Religion — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Religion>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ReligionDomainPolicy = PermitAllPolicy<Religion>;
