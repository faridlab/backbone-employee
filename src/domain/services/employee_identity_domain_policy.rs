//! Domain policy for EmployeeIdentity aggregate
//!
...
/// Domain policy for EmployeeIdentity — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EmployeeIdentity>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EmployeeIdentityDomainPolicy = PermitAllPolicy<EmployeeIdentity>;
